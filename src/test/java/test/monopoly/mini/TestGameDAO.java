...
public class TestGameDAO {
	...
	private void initializePlayers() {
		Color[] colors = {Color.red, Color.blue, Color.green, Color.yellow, Color.black, Color.pink};
